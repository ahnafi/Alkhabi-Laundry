        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white/90 backdrop-blur-sm overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-200">
                <div class="p-6 md:p-8 text-gray-900">
                    ...
                    <div class="mt-6 space-y-4">
                        ...
                        <div class="pt-4 mt-4 border-t flex justify-between items-baseline">
                            ...
                            <span class="text-2xl font-bold text-pink-600">Rp {{ number_format($pesanan->total_harga ?? 0, 0, ',', '.') }}</span>
                        </div>
                    </div>
                    
                    <div class="mt-8 text-center">
                        <p class="text-xs text-gray-500 mb-4">Dengan menekan tombol di bawah, Anda akan diarahkan ke halaman pembayaran aman.</p>
                        <button id="pay-button" class="w-full inline-flex items-center justify-center px-8 py-4 bg-green-500 border border-transparent rounded-lg font-semibold text-lg text-white hover:bg-green-600 transition shadow-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H7a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
                            Bayar Sekarang
                        </button>
                    </div>
                </div>
             ...
             <div class="text-center mt-4">
                <a href="{{ route('riwayat.index') }}" class="text-sm font-medium text-gray-600 hover:text-pink-600 transition">&larr; Kembali ke Riwayat</a>
            </div>
        </div>
    </div>

    <div id="qris-modal" class="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50 transition-opacity duration-300">
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-xs p-6 text-center transform transition-all scale-95 opacity-0" id="modal-content">
            ...
            <p class="text-sm font-bold">Total: <span class="text-pink-600">Rp {{ number_format($pesanan->total_harga ?? 0, 0, ',', '.') }}</span></p>
